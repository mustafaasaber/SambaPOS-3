...
namespace Samba.Modules.AutomationModule
{
    ...
    class TriggerViewModel : EntityViewModelBase<Trigger>
    {
        ...
        public CommonCronSetting SelectedMinuteCronSetting
        {
            ...
            set { _selectedMinuteCronSetting = value; UpdateCronSetting(value); RaisePropertyChanged(nameof( SelectedMinuteCronSetting)); }
        }
        ...
        public CommonCronSetting SelectedHourCronSetting
        {
            ...
            set { _selectedHourCronSetting = value; UpdateCronSetting(value); RaisePropertyChanged(nameof( SelectedHourCronSetting)); }
        }
        ...
        public CommonCronSetting SelectedDayCronSetting
        {
            ...
            set { _selectedDayCronSetting = value; UpdateCronSetting(value); RaisePropertyChanged(nameof( SelectedDayCronSetting)); }
        }
        ...
        public CommonCronSetting SelectedMonthCronSetting
        {
            ...
            set { _selectedMonthCronSetting = value; UpdateCronSetting(value); RaisePropertyChanged(nameof( SelectedMonthCronSetting)); }
        }
        ...
        public CommonCronSetting SelectedWeekdayCronSetting
        {
            ...
            set { _selectedWeekdayCronSetting = value; UpdateCronSetting(value); RaisePropertyChanged(nameof( SelectedWeekdayCronSetting)); }
        }
        ...
        {
            get { return _minute; }
            set { _minute = value; RaisePropertyChanged(nameof( Minute)); UpdateExpression(); }
        }
        ...
        {
            get { return _hour; }
            set { _hour = value; RaisePropertyChanged(nameof( Hour)); UpdateExpression(); }
        }
        ...
        {
            get { return _day; }
            set { _day = value; RaisePropertyChanged(nameof( Day)); UpdateExpression(); }
        }
        ...
        {
            get { return _month; }
            set { _month = value; RaisePropertyChanged(nameof( Month)); UpdateExpression(); }
        }
        ...
        {
            get { return _weekday; }
            set { _weekday = value; RaisePropertyChanged(nameof( Weekday)); UpdateExpression(); }
        }
